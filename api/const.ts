...
export const ISS_PUB_JWK : CryptoKey = await importJWK(JSON.parse(process.env.ISS_PUB_JWK!)) as CryptoKey
export const ISS_DID = `did:jwk:${Buffer.from(process.env.ISS_PUB_JWK || '').toString('base64url')}#0`
